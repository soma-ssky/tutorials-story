...
<div data-role="view" data-layout="overview-layout" id="overview-cities" data-title="뉴스피드">
...
<div data-role="view" data-layout="overview-layout" id="overview-gallery" data-title="내스토리">
...
<div data-role="view" data-layout="overview-layout" id="overview-contacts" data-title="친구목록">
...
<div data-role="view" data-layout="overview-layout" data-init="mobileAccountViewInit" id="overview-account" data-title="더보기">
...
<div data-role="view" data-layout="overview-layout" id="overview-write" data-title="글쓰기" data-init="initForm">
  <form name="myform"><input type="file" id="profilePhotoFileUpload" onclick="fileview_show();">
...
<div data-role="layout" data-id="overview-layout">
    <header data-role="header">
        <div data-role="navbar">
            ...
            <a data-align="right" data-role="button" class="nav-button" data-icon="writeicon" href="#overview-write"></a>
        </div>
    </header>

    <footer data-role="footer">
        <div data-role="tabstrip">
          <a data-icon="bookmarks" href="#overview-cities">뉴스피드
          </a><a data-icon="home" href="#overview-gallery">내스토리
          </a><a data-icon="contacts" href="#overview-contacts">친구목록
          </a><a data-icon="settings" href="#overview-account">더보기</a>
        </div>
    </footer>
